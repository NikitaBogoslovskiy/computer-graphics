...
Scene::Scene()
{
	...
	lights.push_back(new PointLight(HVec<double> {5.0, -7.0, 10.0}, HVec<double> { 1.f, 0.f, 0.f }, 1.0));
	lights.push_back(new PointLight(HVec<double> {-5.0, -7.0, 10.0}, HVec<double> { 0.f, 0.f, 1.f }, 1.0));
}
